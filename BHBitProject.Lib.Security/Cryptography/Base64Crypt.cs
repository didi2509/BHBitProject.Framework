...
namespace BHBitProject.Lib.Security.Cryptography
{
    ...
    public class Base64Crypt
    {
        ...
        public Base64Crypt(CryptProvider cryptProvider)
        {
        ...
        public virtual string Encrypt(string texto)
        {
            ...
            string a = Convert.ToBase64String(cryptoByte, 0, cryptoByte.GetLength(0));

            // Converte para a base 64 string para uso posterior em um xml

            return a.Replace("/", "(!4]1").Replace("==", "(!5]2").Replace("+", "!3]7");
        ...
        public virtual string Decrypt(string textoCriptografado)
        {
            ...
            textoCriptografado = textoCriptografado.Replace("!3]7", "+").Replace("(!4]1", "/").Replace("(!5]2", "=="); ;
