...
namespace BBP.Test.Selenium.Extensions
{
    public static class WebElementExtensions
    {
        ...
        public static void WaitSendKeys(this ICustomWebElement element, string text, bool isWaitVisibleAndEnabled = false)
        {
            if (isWaitVisibleAndEnabled)
            {
                element.WaitEnabled();
        ...
        /// <returns></returns>
        private static ICustomWebElement WaitVisible(this ICustomWebElement customWebElement, bool isInvertInvisible = false)
        {
            return WaitProperty(customWebElement, () => isInvertInvisible ? customWebElement.Displayed : !customWebElement.Displayed, "Visible");
        }
        ...
        /// <returns></returns>
        private static ICustomWebElement WaitEnabled(this ICustomWebElement customWebElement, bool isInvertEnabled = false)
        {
            return WaitProperty(customWebElement, () => isInvertEnabled ? customWebElement.Enabled : !customWebElement.Enabled, "Enabled");
        }
        ...
        /// <returns></returns>
        private static ICustomWebElement WaitSelected(this ICustomWebElement customWebElement, bool isInvertSelected = false)
        {
            return WaitProperty(customWebElement, () => isInvertSelected ? customWebElement.Selected : !customWebElement.Selected, "Selected");
        }
        ...
        /// <returns></returns>
        internal static ICustomWebElement WaitProperty(this ICustomWebElement customWebElement, Func<bool> isTrue, string valorEsperadoError)
        {
            if (customWebElement == null)
                throw new Exception("O elemento não pode ser nulo");
